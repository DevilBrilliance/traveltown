...
export const CHARACTER_ANIM_PATHS: Record<CharacterAnimState, string> = {
    ...
    [CharacterAnimState.PlateIdle]: 'charaction/char/NPC_DXZ/NPC_DXZ_idle',
    [CharacterAnimState.PlateRun]: 'charaction/char/NPC_DXZ/NPC_DXZ_Run',
};
...
export const CHARACTER_ANIM_CLIP_UUIDS: Record<CharacterAnimState, string> = {
    ...
    [CharacterAnimState.PlateIdle]: 'bcb0a8ee-a7f9-487f-93b1-c52890bb31bb@73b7f',
    [CharacterAnimState.PlateRun]: '481e35b7-bc4b-4d6a-843e-9055f27e79e9@73b7f',
};
